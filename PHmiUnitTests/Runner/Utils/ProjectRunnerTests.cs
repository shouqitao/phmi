...
namespace PHmiUnitTests.Runner.Utils {
    public class WhenUsingProjectRunner : Specification {
        ...
        public class AndContextContainsIoDevices : WhenUsingProjectRunner {
            ...
            protected IQueryable<IoDevice> IoDevices;
            ...
            public class AndStarted : AndContextContainsIoDevices {
                ...
                public class ThenIoDeviceRunTargetCreated : AndStarted {
                    [Test]
                    public void Test() {
                        IoDeviceRunTargetFactory.Verify(f => f.Create(TimeService.Object, IoDevice),
                            Times.Once());
                    }
                }
                ...
                public class ThenIoDeviceRunTargetsContainsIoDevicrRunTarget : AndStarted {
                    [Test]
                    public void Test() {
                        Assert.That(ProjectRunner.IoDeviceRunTargets[IoDevice.Id],
                            Is.SameAs(IoDeviceRunTarget.Object));
                    }
                }
                ...
                public class AndStopped : AndStarted {
                    ...
                    public class ThenProjectStoppedIsReported : AndStopped {
                        ...
                        public void Test() {
                            Reporter.Verify(
                                r => r.Report(string.Format(Res.ProjectStoppingMessage, ProjectName), null,
                                    null), Times.Once());
                        }
                    }
                }
                ...
                public class AndCyclicRunnerStopThrows : AndStarted {
                    ...
                    public class AndStopExecuted : AndCyclicRunnerStopThrows {
                        ...
                        public class ThenProjectStoppedIsNotReported : AndStopExecuted {
                            ...
                            public void Test() {
                                Reporter.Verify(
                                    r => r.Report(string.Format(Res.ProjectStoppedMessage, ProjectName), null,
                                        null), Times.Never());
                            }
                        }
                    }
                ...
                public class ThenIoDeviceStartedIsReported : AndStarted {
                    ...
                    public void Test() {
                        Reporter.Verify(
                            r => r.Report(string.Format(Res.IoDeviceStartedMessage, IoDevice.Name), null,
                                null), Times.Once());
                    }
                }
                ...
                public class ThenProjectStartedIsReported : AndStarted {
                    ...
                    public void Test() {
                        Reporter.Verify(
                            r => r.Report(string.Format(Res.ProjectStartedMessage, ProjectName), null, null),
                            Times.Once());
                    }
                }
            }
            ...
            public class AndRunnerStartThrows : AndContextContainsIoDevices {
                ...
                public class AndStartExecuted : AndRunnerStartThrows {
                    ...
                    public class ThenProjectStartedIsNotReported : AndStartExecuted {
                        ...
                        public void Test() {
                            Reporter.Verify(
                                r => r.Report(string.Format(Res.ProjectStartedMessage, ProjectName), null,
                                    null), Times.Never());
                        }
                    }
                }
        ...
        public class AndContextContainsAlarmCategories : WhenUsingProjectRunner {
            ...
            protected override void EstablishContext() {
                ...
                AlarmsRunTargetFactory.Setup(f =>
                        f.Create(DataDbConStr, ProjectRunner, AlarmCategory, TimeService.Object))
            ...
            public class AndStarted : AndContextContainsAlarmCategories {
                ...
                public class ThenAlarmsRunTargetCreated : AndStarted {
                    [Test]
                    public void Test() {
                        AlarmsRunTargetFactory.Verify(
                            f => f.Create(DataDbConStr, ProjectRunner, AlarmCategory, TimeService.Object),
                            Times.Once());
                    }
                }
                ...
                public class ThenAlarmsRunTargetsContainsAlarmsRunTarget : AndStarted {
                    [Test]
                    public void Test() {
                        Assert.That(ProjectRunner.AlarmsRunTargets[AlarmCategory.Id],
                            Is.SameAs(RunTarget.Object));
                    }
                }
                ...
                public class ThenAlarmsStartedIsReported : AndStarted {
                    ...
                    public void Test() {
                        Reporter.Verify(
                            r => r.Report(string.Format(Res.AlarmsStartedMessage, AlarmCategory.Name), null,
                                null), Times.Once());
                    }
                }
            }
        ...
        public class AndContextThrows : WhenUsingProjectRunner {
            ...
            protected override void EstablishContext() {
                ...
                Context.Setup(context => context.Get<IoDevice>()).Throws(ContextException);
            }
        ...
        public class AndStarted1 : WhenUsingProjectRunner {
            ...
            public class ThenStartingProjectReported : AndStarted1 {
                ...
                public void Test() {
                    Reporter.Verify(
                        r => r.Report(string.Format(Res.ProjectStartingMessage, ProjectName), null, null),
                        Times.Once());
                }
            }
            ...
            public class ThenServiceRunnerCreated : AndStarted1 {
                [Test]
                public void Test() {
                    ServiceRunnerFactory.Verify(
                        f => f.Create(ProjectRunner, Server, null, TimeService.Object), Times.Once());
                }
            }
        ...
        public class AndStopped1 : WhenUsingProjectRunner {
            ...
            public class ThenProjectStoppingIsReported : AndStopped1 {
                ...
                public void Test() {
                    Reporter.Verify(
                        r => r.Report(string.Format(Res.ProjectStoppingMessage, ProjectName), null, null),
                        Times.Once());
                }
            }
        }
