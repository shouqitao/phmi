...
namespace PHmiUnitTests.Runner.Utils.IoDeviceRunner {
    public class WhenUsingIoDeviceRunTarget : Specification {
        ...
        public class ThenNameIsSet : WhenUsingIoDeviceRunTarget {
            [Test]
            public void Test() {
                Assert.That(IoDeviceRunTarget.Name,
                    Is.EqualTo(string.Format(Res.IoDeviceWithName, IoDevice.Name)));
            }
        }
        ...
        public class AndCallingRun : WhenUsingIoDeviceRunTarget {
            ...
            public class AndCallingRunAgain : AndCallingRun {
                ...
                public class ThenWrapperCreateNotExecuted : AndCallingRunAgain {
                    [Test]
                    public void Test() {
                        IoDeviceWrapper.Verify(w => w.Create(It.IsAny<string>(), It.IsAny<string>()),
                            Times.Once());
                    }
                }
            }
            ...
            public class AndIoDeviceWrapperFactoryUnloadDomainThrows : AndCallingRun {
                ...
                protected override void EstablishContext() {
                    ...
                    IoDeviceWrapperFactory.Setup(w => w.UnloadDomain())
                        .Throws(IoDeviceWrapperFactoryUnloadDomainException);
                }
                ...
                public class AndCallingClean1 : AndIoDeviceWrapperFactoryUnloadDomainThrows {
                    ...
                    public class ThenExceptionIsThrown : AndCallingClean1 {
                        [Test]
                        public void Test() {
                            Assert.That(ThrownException,
                                Is.SameAs(IoDeviceWrapperFactoryUnloadDomainException));
                        }
                    }
                }
            }
        ...
        public class AndSettedValue : WhenUsingIoDeviceRunTarget {
            ...
            protected override void EstablishContext() {
                ...
                IoDeviceRunTarget.SetNumericValue(NumericTag.Id, SettedNumericValue);
                SettedWriteOnlyNumericValue = random.Next(short.MinValue, short.MaxValue);
                IoDeviceRunTarget.SetNumericValue(WriteOnlyNumericTag.Id, SettedWriteOnlyNumericValue);
            }
                    ...
                    public void Test() {
                        Func<WriteParameter[], bool> f = parameters => {
                            ...
                            if (!parameters.Any(
                                ...
                                return false;
                            if (!parameters.Any(
                                p => p.Address == WriteOnlyDigitalTag.Device &&
                                     p.Value.Equals(SettedWriteOnlyDigitalValue)))
                                return false;
                            if (!parameters.Any(
                                p => p.Address == NumericTag.Device &&
                                     p.Value.Equals((int) SettedNumericValue)))
                                return false;
                            if (!parameters.Any(
                                p => p.Address == WriteOnlyNumericTag.Device &&
                                     p.Value.Equals((short) SettedWriteOnlyNumericValue)))
                                return false;
                            return true;
                        };
                        IoDeviceWrapper
