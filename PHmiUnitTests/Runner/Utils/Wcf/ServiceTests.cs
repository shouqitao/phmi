        ...
        public class AndProjectContainsIoDeviceRunTarget : WhenWorkingWithService {
            ...
            public class AndRemapTagsInvoked : AndProjectContainsIoDeviceRunTarget {
                ...
                protected override void EstablishContext() {
                    ...
                    IoDeviceRunTarget.Setup(t => t.GetDigitalValue(DigReadId)).Returns(DigReadValue)
                        .Verifiable();
                    IoDeviceRunTarget.Setup(t => t.GetNumericValue(NumReadId)).Returns(NumReadValue)
                        .Verifiable();
                ...
                public class ThenRemapPerformed : AndRemapTagsInvoked {
                    ...
                    public void SetDigTagsPerformed() {
                        IoDeviceRunTarget.Verify(
                            t => t.SetDigitalValue(RemapTagsParameter.DigWriteIds[0],
                                RemapTagsParameter.DigWriteValues[0]), Times.Once());
                    }

                    [Test]
                    public void SetNumTagsPerformed() {
                        IoDeviceRunTarget.Verify(
                            t => t.SetNumericValue(RemapTagsParameter.NumWriteIds[0],
                                RemapTagsParameter.NumWriteValues[0]), Times.Once());
                    }
                ...
                public class ThenNotificationsPassedToResult : AndRemapTagsInvoked {
                    ...
                    public void Test() {
                        ...
                        Assert.That(RemapTagsResult[0].Notifications[0].StartTime,
                            Is.EqualTo(Notifications[0].StartTime));
                        Assert.That(RemapTagsResult[0].Notifications[0].Message,
                            Is.EqualTo(Notifications[0].Message));
                        Assert.That(RemapTagsResult[0].Notifications[0].ShortDescription,
                            Is.EqualTo(Notifications[0].ShortDescription));
                        Assert.That(RemapTagsResult[0].Notifications[0].LongDescription,
                            Is.EqualTo(Notifications[0].LongDescription));
                    }
                }
            ...
            public class AndReadOnlyRemapTagsInvoked : AndProjectContainsIoDeviceRunTarget {
                ...
                public class ThenRemapPerformed : AndReadOnlyRemapTagsInvoked {
                    ...
                    public void SetDigTagsNotPerformed() {
                        IoDeviceRunTarget.Verify(t => t.SetDigitalValue(It.IsAny<int>(), It.IsAny<bool>()),
                            Times.Never());
                    }

                    [Test]
                    public void SetNumTagsNotPerformed() {
                        IoDeviceRunTarget.Verify(t => t.SetNumericValue(It.IsAny<int>(), It.IsAny<double>()),
                            Times.Never());
                    }
            ...
            public class AndRemapAlarmsInvoked : AndProjectContainsAlarmsRunTarget {
                ...
                public class ThenReporterNotificationsAreRead : AndRemapAlarmsInvoked {
                    ...
                    public void Test() {
                        ...
                        Assert.That(Result.Notifications.Single().ShortDescription ==
                                    Notification.ShortDescription);
                        Assert.That(Result.Notifications.Single().LongDescription ==
