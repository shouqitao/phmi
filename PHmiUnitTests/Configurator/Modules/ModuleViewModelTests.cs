...
namespace PHmiUnitTests.Configurator.Modules {
    ...
    public class ModuleViewModelTests {
        ...
        public void SetUp() {
            ...
            _service.ContextFactoryStub.Setup(c => c.Create("ConnectionString", true))
        ...
        private class ModuleViewModel : PHmiConfigurator.Modules.ModuleViewModel {
            ...
            public override bool IsValid {
                get { return base.IsValid && _isValid; }
            }
        ...
        private static readonly object[] ErrorTestCases = {"Error", null, string.Empty};
        ...
        [Test]
        [TestCaseSource("CloseWhenContextHasChangesTestCases")]
        ...
        public void ContextPropertyChangedRaisesHasChangesPropertyChanged() {
            ...
            _viewModel.PropertyChanged += (sender, args) => {
                if (args.PropertyName == "HasChanges") raised = true;
            };
        ...
        public void ReloadAsksYesNolIfContextHasChanges() {
            ...
            _service.DialogHelperStub.Verify(
                d => d.Message(
                    It.IsAny<string>(), _viewModel.Name, MessageBoxButton.YesNo, MessageBoxImage.Question,
                    _viewModel.View));
            _contextStub.Verify();
        }
        ...
        public void ReloadWhenContextHasChangesTest(bool messageResult) {
            ...
            bool result = _viewModel.Reload();
            _service.ContextFactoryStub.Verify(f => f.Create(_viewModel.ConnectionString, true),
                Times.Exactly(messageResult ? 2 : 1));
        ...
        public void SavePromptsIfIsValidReturnsFalse() {
            ...
            _service.DialogHelperStub.Verify(
                h => h.Message(It.IsAny<string>(), It.IsAny<string>(), MessageBoxButton.OK,
                    MessageBoxImage.Error, It.IsAny<object>()));
        }
