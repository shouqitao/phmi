    ...
    public partial class IoDeviceTypeEditor : UserControl {
        ...
        private void IoDeviceTypeEditorLoaded(object sender, RoutedEventArgs e) {
            ...
            if (!DesignerProperties.GetIsInDesignMode(this)) {
                ...
                foreach (TreeViewItem i in IoDeviceDirectoryItem.GetItems(path)) treeView.Items.Add(i);
                Action action = () =>
                    UpdateType(Type);
        ...
        private void Select(Stack<string> path, TreeViewItem[] items) {
            ...
            if (path.Any())
                ...
                foreach (IoDeviceItem item in items.OfType<IoDeviceItem>().Where(item => item.ItemName == s)
                ) {
        ...
        private static void OnTypeChangedCallback(DependencyObject obj,
