...
namespace PHmiClient.Controls {
    public abstract class PaginatorControl : Control {
        ...
        private void RefreshCommandCanExecuteChanged(object sender, EventArgs e) {
            if (_paginator.RefreshCommand.CanExecute(null)) CheckAutoRefresh();
        }

        private void PaginatorPropertyChanged(object sender, PropertyChangedEventArgs e) {
        ...
        private void UpdatePageSize() {
            ...
            int oldPageSize = _paginator.PageSize;
            _paginator.PageSize =
                (int) Math.Max((ActualHeight - ControlHeightWithoutItemContainer) / ItemHeight, 0);
        ...
        private static void OnItemHeightPropertyChanged(DependencyObject d,
        ...
        public static readonly DependencyProperty ControlHeightWithoutItemContainerProperty =
        ...
        private static void OnControlHeightWithoutItemContainerPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e) {
            var c = (PaginatorControl) d;
            c.UpdatePageSize();
        }

        #endregion ControlHeightWithoutItemContainer
        ...
        private static void AutoRefreshPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e) {
