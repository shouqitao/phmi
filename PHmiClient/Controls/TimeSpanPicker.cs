...
namespace PHmiClient.Controls {
    public class TimeSpanPicker : Control {
        ...
        private void Update(TimeSpan? newValue) {
            ...
            TimeSpan timeSpan = newValue.Value;
        ...
        private void UpdateDays(int? newDays) {
            ...
            int days = newDays.Value;
            TimeSpan timeSpan = TimeSpan.HasValue ? TimeSpan.Value : new TimeSpan();
            TimeSpan difference = System.TimeSpan.FromDays(days - timeSpan.Days);
        ...
        private void UpdateHours(int? newHours) {
            ...
            int hours = newHours.Value;
            TimeSpan timeSpan = TimeSpan.HasValue ? TimeSpan.Value : new TimeSpan();
            TimeSpan difference = System.TimeSpan.FromHours(hours - timeSpan.Hours);
            TimeSpan = timeSpan + difference;
        }
        ...
        private void UpdateMinutes(int? newMinutes) {
            ...
            int minutes = newMinutes.Value;
            TimeSpan timeSpan = TimeSpan.HasValue ? TimeSpan.Value : new TimeSpan();
            TimeSpan difference = System.TimeSpan.FromMinutes(minutes - timeSpan.Minutes);
            TimeSpan = timeSpan + difference;
        }
        ...
        private void UpdateSeconds(int? newSeconds) {
            ...
            int seconds = newSeconds.Value;
            TimeSpan timeSpan = TimeSpan.HasValue ? TimeSpan.Value : new TimeSpan();
            TimeSpan difference = System.TimeSpan.FromSeconds(seconds - timeSpan.Seconds);
            TimeSpan = timeSpan + difference;
        }
        ...
        private void UpdateMilliseconds(int? newMilliseconds) {
            ...
            int milliseconds = newMilliseconds.Value;
            TimeSpan timeSpan = TimeSpan.HasValue ? TimeSpan.Value : new TimeSpan();
            TimeSpan difference = System.TimeSpan.FromMilliseconds(milliseconds - timeSpan.Milliseconds);
            TimeSpan = timeSpan + difference;
        }
        ...
        private static void
            TimeSpanPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
        ...
        private static void MillisecondsPropertyChanged(DependencyObject d,
        ...
        #endregion TimeSpanMilliseconds
    }
}