...
namespace PHmiClient.Controls.Trends {
    public class TrendPen : DependencyObject {
        ...
        private static void OnTrendTagChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            if (!trendPen.MaxValue.HasValue) trendPen.MaxValue = newTag.MaxValue;
            if (!trendPen.MinValue.HasValue) trendPen.MinValue = newTag.MinValue;
        }
        ...
        public static readonly DependencyProperty BrushProperty =
            DependencyProperty.Register("Brush", typeof(Brush), typeof(TrendPen),
        ...
        public static readonly DependencyProperty ThicknessProperty =
            DependencyProperty.Register("Thickness", typeof(double), typeof(TrendPen),
