...
namespace PHmiClient.Controls.Pages {
    public class UsersPage : PaginatorControl, IPage {
        ...
        public UsersPage() {
            Paginator = new Paginator<User, string>(
                user => user.Name, (user, newUser) => user.UpdateFrom(newUser));
            SetPaginator(Paginator);
            _setPasswordCommand =
                new DelegateCommand(SetPasswordCommandExecuted, SetPasswordCommandCanExecute);
        ...
        public IPaginator<User, string> Paginator { get; }
        ...
        private class PaginationService : IPaginationService<User, string> {
            ...
            public void GetItems(CriteriaType criteriaType, int maxCount, string criteria,
        ...
        private static void PHmiPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            page.Paginator.PaginationService = pHmi == null ? null : new PaginationService(pHmi.Users);
        }
        ...
        private static void SelectedUserPropertyChanged(DependencyObject d,
        ...
        private void SetPasswordCommandExecuted(object obj) {
            ...
            if (SetPasswordDialogStyle != null) dialog.Style = SetPasswordDialogStyle;
        ...
        #endregion SetPasswordDialogStyle

        #endregion SetPasswordCommand
        ...
        private void EditUserCommandExecuted(object obj) {
            ...
            if (EditUserDialogStyle != null) dialog.Style = EditUserDialogStyle;
        ...
        private void AddUserCommandExecuted(object obj) {
            ...
            if (AddUserDialogStyle != null) dialog.Style = AddUserDialogStyle;
            var result = dialog.ShowDialog(this);
            if (result == true && Paginator.RefreshCommand.CanExecute(null))
                Paginator.RefreshCommand.Execute(null);
        }
