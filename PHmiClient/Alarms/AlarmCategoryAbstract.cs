...
namespace PHmiClient.Alarms {
    public abstract class AlarmCategoryAbstract : INotifyPropertyChanged {
        ...
        protected abstract void AddAlarmInfo(int id, Func<string> locationGetter,
        ...
        public abstract void GetCurrent(CriteriaType criteriaType, AlarmSampleId criteria, int maxCount,
