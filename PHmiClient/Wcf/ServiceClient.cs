    ...
    internal sealed class ServiceClient : ClientBase<IService>, IServiceClient {
        ...
        private void Initialize(string guid) {
            ...
            Endpoint.Contract.Behaviors.Add(
                new HeaderEncriptionContractBehavior(GuidHeaderName, GuidHeaderNamespace));
        }

        private T Invoke<T>(Func<T> func) {
            using (new OperationContextScope(InnerChannel)) {
                var guidHeader = new MessageHeader<string>(_guid);
                MessageHeader untypedGuidHeader =
                    guidHeader.GetUntypedHeader(GuidHeaderName, GuidHeaderNamespace);
        ...
        private T Invoke<TP1, TP2, TP3, T>(Func<TP1, TP2, TP3, T> func, TP1 parameter1, TP2 parameter2,
            TP3 parameter3) {
            return Invoke(() => func.Invoke(parameter1, parameter2, parameter3));
        }

        private T Invoke<TP1, TP2, TP3, TP4, T>(Func<TP1, TP2, TP3, TP4, T> func, TP1 parameter1,
            TP2 parameter2, TP3 parameter3, TP4 parameter4) {
