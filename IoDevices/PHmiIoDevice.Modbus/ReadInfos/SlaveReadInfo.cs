...
namespace PHmiIoDevice.Modbus.ReadInfos {
    internal class SlaveReadInfo {
        ...
        public readonly Dictionary<ReadParameter, ushort> CoilsAddresses =
            new Dictionary<ReadParameter, ushort>();

        public readonly List<ushort> Contacts = new List<ushort>();

        public readonly Dictionary<ReadParameter, ushort> ContactsAddresses =
            new Dictionary<ReadParameter, ushort>();

        public readonly List<KeyValuePair<ushort, int>> HoldingRegisters =
            new List<KeyValuePair<ushort, int>>();
        ...
        public readonly List<KeyValuePair<ushort, int>>
            InputRegisters = new List<KeyValuePair<ushort, int>>();
