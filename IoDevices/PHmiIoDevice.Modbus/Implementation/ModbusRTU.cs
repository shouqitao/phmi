...
namespace PHmiIoDevice.Modbus.Implementation {
    internal class ModbusRTU : ModbusBase {
        ...
        protected override List<byte> Read(
            ...
            if (response == null || response.Count < 5) throw new Exception("No response");
            ...
            if (response.Count != byteLength + 5) throw new Exception("Unexpected packet length");
            ...
            int dataBytesLength = response.Count - 5;
        ...
        protected override bool Write(byte slaveAddress, int address, int byteLength, List<byte> pdu) {
            ...
            if (response.Count != 8) throw new Exception("Unexpected packet length");
