...
namespace JetBrains.Annotations {
    ...
    ///     Using "halt" (or "void"/"nothing", which is the same) for method output means that methos doesn't return
    ///     normally. <br />
    ///     "canbenull" annotation is only applicable for output parameters. <br />
    ///     You can use multiple [ContractAnnotation] for each FDT row, or use single attribute with rows separated
    ///     by semicolon. <br />
    /// </syntax>
    /// <examples>
    ///     <list>
    ...
    ///         <item>
    ///             [ContractAnnotation("halt &lt;= condition: false")] public void Assert(bool condition, string
    ///             text) // Regular Assertion method
    ///         </item>
    ///         <item>
    ///             [ContractAnnotation("s:null => true")] public bool IsNullOrEmpty(string s) //
    ...
    /// <summary>
    ///     Indicates that the value of marked type (or its derivatives) cannot be compared using '==' or '!='
    ///     operators.
    ...
    /// <summary>
    ///     This attribute is intended to mark publicly available API which should not be removed and so is treated
    ///     as used.
    /// </summary>
    [MeansImplicitUse]
