        ...
        public class AndInvokedReport : WhenUsingNotificationReporter {
            ...
            public class AndExpirationTimeElapsed : AndInvokedReport {
                ...
                public class AndNowResetNonExistentNotificationInvoked : AndExpirationTimeElapsed {
                    protected override void EstablishContext() {
                        base.EstablishContext();
                        NotificationReporter.Reset(
                            new Notification(StartTime, Message, ShortDescription, LongDescription) {
            ...
            public class AndReportedAgainTheSameNotification : AndInvokedReport {
                ...
                public class AndExpirationTimeElapsedFromFirstReport : AndReportedAgainTheSameNotification {
                    protected override void EstablishContext() {
                        base.EstablishContext();
                        DateTime now = StartTime.Add(NotificationReporter.ExpirationTime).AddTicks(1);
                        TimeServiceMock.Setup(s => s.UtcTime).Returns(now);
                        TimerServiceMock.Raise(s => s.Elapsed += null, EventArgs.Empty);
                    }

                    public class
                        ThenNotificationShouldNotHaveEndTime : AndExpirationTimeElapsedFromFirstReport {
                        [Test]
                        public void Test() {
                    ...
                    public class
                        ThenContainsActiveNotificationsIsStillTrue : AndExpirationTimeElapsedFromFirstReport {
                        [Test]
                        public void Test() {
                            Assert.That(NotificationReporter.ContainsActiveNotifications, Is.True);
                        }
                ...
                public class AndExpirationTimeElapsedFromSecondReport : AndReportedAgainTheSameNotification {
                    protected override void EstablishContext() {
                        base.EstablishContext();
                        DateTime now = LaterTime.Add(NotificationReporter.ExpirationTime).AddTicks(1);
                        TimeServiceMock.Setup(s => s.UtcTime).Returns(now);
                        TimerServiceMock.Raise(s => s.Elapsed += null, EventArgs.Empty);
                    }

                    public class
                        ThenNotificationShouldHaveEndTime : AndExpirationTimeElapsedFromSecondReport {
                        [Test]
                        public void Test() {
                    ...
                    public class
                        ThenContainsActiveNotificationsIsFalseNow : AndExpirationTimeElapsedFromSecondReport {
                        [Test]
                        public void Test() {
                            Assert.That(NotificationReporter.ContainsActiveNotifications, Is.False);
                        }
