    ...
    public class WhenUsingPaginator : Specification {
        ...
        public class AndPaginationServiceSetted : WhenUsingPaginator {
            ...
            protected override void EstablishContext() {
                ...
                PaginationService
                    .Setup(s => s.GetItems(It.IsAny<CriteriaType>(), It.IsAny<int>(), It.IsAny<int>(),
                        It.IsAny<Action<IEnumerable<Item>>>()))
                    .Callback(
                        new Action<CriteriaType, int, int, Action<IEnumerable<Item>>>(MockGetItemsCallback));
                Paginator.PaginationService = PaginationService.Object;
            }

            private void MockGetItemsCallback(CriteriaType criteriaType, int maxCount, int criteria,
                Action<IEnumerable<Item>> callback) {
            ...
            public class AndRefreshCommandExecuted : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeDownFromInfinity :
                        AndRefreshCommandExecuted {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.DownFromInfinity, Paginator.PageSize,
                                It.IsAny<int>(), It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }
                ...
                public class AndCallbackReturnsPageSizeElementCount : AndRefreshCommandExecuted {
                    ...
                    public class
                        AndPageSizeChangedToLessThanItemsCount : AndCallbackReturnsPageSizeElementCount {
                        protected override void EstablishContext() {
                            base.EstablishContext();
                    ...
                    public class
                        ThenCriteriaIsSetToUpperElementCriteria : AndCallbackReturnsPageSizeElementCount {
                        [Test]
                        public void Test() {
                ...
                public class AndCallbackReturnsLessThanPageSizeElementCount : AndRefreshCommandExecuted {
                    ...
                    public class
                        ThenDownCommandCanExecuteIsFalse1 : AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
                            Assert.That(Paginator.DownCommand.CanExecute(null), Is.False);
                        }
                    ...
                    public class
                        ThenUpCommandCanExecuteIsFalse1 : AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
                            Assert.That(Paginator.UpCommand.CanExecute(null), Is.False);
                        }
                    ...
                    public class
                        ThenCriteriaIsSetToUpperElementCriteria :
                            AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
                            Assert.That(Paginator.Criteria, Is.EqualTo(Item1.Criteria));
                        }
            ...
            public class AndDownDownCommandExecuted : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFromInfinity :
                        AndDownDownCommandExecuted {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.UpFromInfinity, Paginator.PageSize, It.IsAny<int>(),
                                It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }
            }
            ...
            public class AndRefreshInvokedWithTypeDownFrom : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeDownFrom :
                        AndRefreshInvokedWithTypeDownFrom {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.DownFrom, Paginator.PageSize, It.IsAny<int>(),
                                It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }
                ...
                public class AndCallbackReturnsPageSizeElementCount : AndRefreshInvokedWithTypeDownFrom {
                    ...
                    public class
                        AndPageSizeChangedToMoreThanItemsCount : AndCallbackReturnsPageSizeElementCount {
                        protected override void EstablishContext() {
                            base.EstablishContext();
                ...
                public class
                    AndCallbackReturnsLessThanPageSizeElementCount : AndRefreshInvokedWithTypeDownFrom {
                    protected Item Item1;
                    protected Item Item2;
                    ...
                    public class
                        ThenUpCommandCanExecuteIsTrue : AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
                            Assert.That(Paginator.UpCommand.CanExecute(null), Is.True);
                        }
                ...
                public class AndCallbackReturns0Elements : AndRefreshInvokedWithTypeDownFrom {
                    ...
                    public class AndUpCommandExecuted : AndCallbackReturns0Elements {
                        ...
                        public class
                            ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFromOrEqual :
                                AndUpCommandExecuted {
                            [Test]
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.UpFromOrEqual, Paginator.PageSize,
                                        It.IsAny<int>(), It.IsAny<Action<IEnumerable<Item>>>()),
                                    Times.Once());
                            }
                        }
                    }
            ...
            public class AndRefreshInvokedWithTypeDownFromOrEqual : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeDownFromOrEqual :
                        AndRefreshInvokedWithTypeDownFromOrEqual {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.DownFromOrEqual, Paginator.PageSize, It.IsAny<int>(),
                                It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }

                public class
                    AndCallbackReturnsPageSizeElementCount : AndRefreshInvokedWithTypeDownFromOrEqual {
                    protected Item Item1;
                    protected Item Item2;
                    protected Item Item3;
                ...
                public class AndCallbackReturns0Elements : AndRefreshInvokedWithTypeDownFromOrEqual {
                    ...
                    public class AndUpCommandExecuted : AndCallbackReturns0Elements {
                        ...
                        public class
                            ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFrom :
                                AndUpCommandExecuted {
                            [Test]
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.UpFrom, Paginator.PageSize, It.IsAny<int>(),
                                        It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                            }
                        }
                    }
            ...
            public class AndRefreshInvokedWithTypeUpFromOrEqual : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFromOrEqual :
                        AndRefreshInvokedWithTypeUpFromOrEqual {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.UpFromOrEqual, Paginator.PageSize, 100,
                                It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }
                ...
                public class AndCallbackReturnsPageSizeElementCount : AndRefreshInvokedWithTypeUpFromOrEqual {
                    ...
                    public class AndDownCommandExecuted : AndCallbackReturnsPageSizeElementCount {
                        ...
                        public class ThenRefreshInvoked : AndDownCommandExecuted {
                            ...
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.DownFrom, Paginator.PageSize, Item3.Criteria,
                                        It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                            }
                        }
                    }
                    ...
                    public class AndUpCommandExecuted : AndCallbackReturnsPageSizeElementCount {
                        ...
                        public class ThenRefreshInvoked : AndUpCommandExecuted {
                            ...
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.UpFrom, Paginator.PageSize, Item1.Criteria,
                                        It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                            }
                        }
                    }
                ...
                public class
                    AndCallbackReturnsLessThanPageSizeElementCount : AndRefreshInvokedWithTypeUpFromOrEqual {
                    protected Item Item1;
                    protected Item Item2;
                    ...
                    public class
                        ThenDownCommandCanExecuteIsTrue : AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
                            Assert.That(Paginator.DownCommand.CanExecute(null), Is.True);
                        }
                ...
                public class AndCallbackReturns0Elements : AndRefreshInvokedWithTypeUpFromOrEqual {
                    ...
                    public class AndDownCommandExecuted : AndCallbackReturns0Elements {
                        ...
                        public class
                            ThenPaginationServiceGetItemsInvokedWithCriteriaTypeDownFrom :
                                AndDownCommandExecuted {
                            [Test]
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.DownFrom, Paginator.PageSize,
                                        It.IsAny<int>(), It.IsAny<Action<IEnumerable<Item>>>()),
                                    Times.Once());
                            }
                        }
            ...
            public class AndRefreshInvokedWithTypeUpFrom : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFrom :
                        AndRefreshInvokedWithTypeUpFrom {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.UpFrom, Paginator.PageSize, 100,
                                It.IsAny<Action<IEnumerable<Item>>>()), Times.Once());
                    }
                }
                ...
                public class
                    AndCallbackReturnsLessThanPageSizeElementCount : AndRefreshInvokedWithTypeUpFrom {
                    protected Item Item1;
                    protected Item Item2;
                ...
                public class AndCallbackReturns0Elements : AndRefreshInvokedWithTypeUpFrom {
                    ...
                    public class AndDownCommandExecuted : AndCallbackReturns0Elements {
                        ...
                        public class
                            ...
                            public void Test() {
                                PaginationService.Verify(
                                    s => s.GetItems(CriteriaType.DownFromOrEqual, Paginator.PageSize,
                                        It.IsAny<int>(), It.IsAny<Action<IEnumerable<Item>>>()),
                                    Times.Once());
                            }
                        }
            ...
            public class AndRefreshInvokedWithTypeUpFromInfinity : AndPaginationServiceSetted {
                ...
                public class
                    ThenPaginationServiceGetItemsInvokedWithCriteriaTypeUpFromInfinity :
                        AndRefreshInvokedWithTypeUpFromInfinity {
                    [Test]
                    public void Test() {
                        PaginationService.Verify(
                            s => s.GetItems(CriteriaType.UpFromInfinity, Paginator.PageSize, It.IsAny<int>(),
                ...
                public class
                    AndCallbackReturnsPageSizeElementCount : AndRefreshInvokedWithTypeUpFromInfinity {
                    protected Item Item1;
                    protected Item Item2;
                    protected Item Item3;
                    ...
                    public class
                        ThenCriteriaIsSetToLowerElementCriteria : AndCallbackReturnsPageSizeElementCount {
                        [Test]
                        public void Test() {
                ...
                public class
                    AndCallbackReturnsLessThanPageSizeElementCount : AndRefreshInvokedWithTypeUpFromInfinity {
                    protected Item Item1;
                    protected Item Item2;
                    ...
                    public class
                        ThenCriteriaIsSetToLowerElementCriteria :
                            AndCallbackReturnsLessThanPageSizeElementCount {
                        [Test]
                        public void Test() {
