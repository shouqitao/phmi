    ...
    public class WhenUsingRoot : Specification {
        ...
        public class AndRegisteredForCommandsCanCanExecuteChanged : WhenUsingRoot {
            ...
            protected override void EstablishContext() {
                base.EstablishContext();
                HomeCount = 0;
                Root.HomeCommand.CanExecuteChanged += (sender, args) => { HomeCount++; };
                BackCount = 0;
                Root.BackCommand.CanExecuteChanged += (sender, args) => { BackCount++; };
                ForwardCount = 0;
                Root.ForwardCommand.CanExecuteChanged += (sender, args) => { ForwardCount++; };
            }
